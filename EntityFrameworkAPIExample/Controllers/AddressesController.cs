...
namespace EntityFrameworkAPIExample.Controllers
{
    ...
    public class AddressesController : ControllerBase
    {
        ...
        [HttpGet("{streetName}/{streetNo}")]
        public async Task<ActionResult<IEnumerable<Address>>> GetAddressesByStreetName(string streetName, string streetNo)
        {
            return await _context.Addresses.Where(
                address => address.StreetName == streetName && address.StreetNo == streetNo).ToListAsync();
        }
